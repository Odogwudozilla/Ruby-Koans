...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject is like the iterative method on steriods. So for instance if you want to add an array of numbers, inject method allows you to perfor the additions in one line
  end
  ...
  #   # code to read 'file'
  #
  # Here we are directly making changes to the file rather thn reading thr file only
